...
BOOST_PYTHON_MODULE(viennagrid_wrapper)
{
	...
	class_<PointCartesian3D>("_PointCartesian3D")
		...
		.add_property("coords", &PointCartesian3D::get_coord_list)
		.def("get_coord", &PointCartesian3D::get_coord)
		.def("set_coord", &PointCartesian3D::set_coord)
		.def(self == self)
		.def(self + self)
		.def(self - self)
		.def(self * double())
	...
	class_<PointCylindrical3D>("_PointCylindrical3D")
		...
		.add_property("coords", &PointCylindrical3D::get_coord_list)
		.def("get_coord", &PointCylindrical3D::get_coord)
		.def("set_coord", &PointCylindrical3D::set_coord)
		.def(self == self)
		.def(self + self)
		.def(self - self)
		.def(self * double())
	...
	class_<PointPolar2D>("_PointPolar2D")
		...
		.add_property("coords", &PointPolar2D::get_coord_list)
		.def("get_coord", &PointPolar2D::get_coord)
		.def("set_coord", &PointPolar2D::set_coord)
		.def(self == self)
		.def(self + self)
		.def(self - self)
		.def(self * double())
