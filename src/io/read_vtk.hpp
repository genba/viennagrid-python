 ...
 * 
 * @file
 * @brief Function definitions for implementing the VTK reader.
 */
...
void LinearCartesian1D_Domain_read_vtk(str filename, LinearCartesian1D_Domain domain, object arg1 = object(), dict arg2 = dict());
void LinearCartesian2D_Domain_read_vtk(str filename, LinearCartesian2D_Domain domain, object arg1 = object(), dict arg2 = dict());
void LinearCartesian3D_Domain_read_vtk(str filename, LinearCartesian3D_Domain domain, object arg1 = object(), dict arg2 = dict());
void LinearCylindrical3D_Domain_read_vtk(str filename, LinearCylindrical3D_Domain domain, object arg1 = object(), dict arg2 = dict());
void LinearPolar2D_Domain_read_vtk(str filename, LinearPolar2D_Domain domain, object arg1 = object(), dict arg2 = dict());
void LinearSpherical3D_Domain_read_vtk(str filename, LinearSpherical3D_Domain domain, object arg1 = object(), dict arg2 = dict());
...
void TriangularCartesian2D_Domain_read_vtk(str filename, TriangularCartesian2D_Domain domain, object arg1 = object(), dict arg2 = dict());
void TriangularCartesian3D_Domain_read_vtk(str filename, TriangularCartesian3D_Domain domain, object arg1 = object(), dict arg2 = dict());
void TriangularCylindrical3D_Domain_read_vtk(str filename, TriangularCylindrical3D_Domain domain, object arg1 = object(), dict arg2 = dict());
void TriangularPolar2D_Domain_read_vtk(str filename, TriangularPolar2D_Domain domain, object arg1 = object(), dict arg2 = dict());
void TriangularSpherical3D_Domain_read_vtk(str filename, TriangularSpherical3D_Domain domain, object arg1 = object(), dict arg2 = dict());
...
void QuadrilateralCartesian2D_Domain_read_vtk(str filename, QuadrilateralCartesian2D_Domain domain, object arg1 = object(), dict arg2 = dict());
void QuadrilateralCartesian3D_Domain_read_vtk(str filename, QuadrilateralCartesian3D_Domain domain, object arg1 = object(), dict arg2 = dict());
void QuadrilateralCylindrical3D_Domain_read_vtk(str filename, QuadrilateralCylindrical3D_Domain domain, object arg1 = object(), dict arg2 = dict());
void QuadrilateralPolar2D_Domain_read_vtk(str filename, QuadrilateralPolar2D_Domain domain, object arg1 = object(), dict arg2 = dict());
void QuadrilateralSpherical3D_Domain_read_vtk(str filename, QuadrilateralSpherical3D_Domain domain, object arg1 = object(), dict arg2 = dict());
...
void TetrahedralCartesian3D_Domain_read_vtk(str filename, TetrahedralCartesian3D_Domain domain, object arg1 = object(), dict arg2 = dict());
void TetrahedralCylindrical3D_Domain_read_vtk(str filename, TetrahedralCylindrical3D_Domain domain, object arg1 = object(), dict arg2 = dict());
void TetrahedralSpherical3D_Domain_read_vtk(str filename, TetrahedralSpherical3D_Domain domain, object arg1 = object(), dict arg2 = dict());
