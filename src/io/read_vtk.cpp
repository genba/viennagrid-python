...
void LinearCartesian1D_Domain_read_vtk(str filename,
                                       ...
                                       dict arg2)
{
	...
	// read_vtk(filename, domain, accessors)
	...
	else
	{
		...
		if (segmentation == NULL)
			...
			my_vtk_reader(domain.get_domain(), segmentation->get_segmentation(), extract<std::string>(filename));
	}
}

void LinearCartesian2D_Domain_read_vtk(str filename,
...
void LinearCartesian3D_Domain_read_vtk(str filename,
...
void LinearCylindrical3D_Domain_read_vtk(str filename,
...
void LinearPolar2D_Domain_read_vtk(str filename,
...
void LinearSpherical3D_Domain_read_vtk(str filename,
...
void TriangularCartesian2D_Domain_read_vtk(str filename,
...
void TriangularCartesian3D_Domain_read_vtk(str filename,
...
void TriangularCylindrical3D_Domain_read_vtk(str filename,
...
void TriangularPolar2D_Domain_read_vtk(str filename,
...
void TriangularSpherical3D_Domain_read_vtk(str filename,
...
void QuadrilateralCartesian2D_Domain_read_vtk(str filename,
...
void QuadrilateralCartesian3D_Domain_read_vtk(str filename,
...
void QuadrilateralCylindrical3D_Domain_read_vtk(str filename,
...
void QuadrilateralPolar2D_Domain_read_vtk(str filename,
...
void QuadrilateralSpherical3D_Domain_read_vtk(str filename,
...
void TetrahedralCartesian3D_Domain_read_vtk(str filename,
...
void TetrahedralCylindrical3D_Domain_read_vtk(str filename,
...
void TetrahedralSpherical3D_Domain_read_vtk(str filename,
