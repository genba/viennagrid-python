...
TriangularCartesian2D_Segment::TriangularCartesian2D_Segment(TriangularCartesian2D_Segment_t &initial_segment) : segment(initial_segment)
{
...
void TriangularCartesian2D_Segment::create_cell(PointCartesian2D vertex1, PointCartesian2D vertex2, PointCartesian2D vertex3)
{
	...
	viennagrid::create_element<TriangularCartesian2D_Cell_t>(segment, vertices.begin(), vertices.end());
	*/
...
TriangularCartesian3D_Segment::TriangularCartesian3D_Segment(TriangularCartesian3D_Segment_t &initial_segment) : segment(initial_segment)
{
	//segment = initial_segment;
}
...
void TriangularCartesian3D_Segment::create_cell(PointCartesian3D vertex1, PointCartesian3D vertex2, PointCartesian3D vertex3)
{
	...
	vertices[1] = viennagrid::elements<viennagrid::vertex_tag>(domain->get_domain()).handle_at(vertex2.get_id());
	vertices[2] = viennagrid::elements<viennagrid::vertex_tag>(domain->get_domain()).handle_at(vertex3.get_id());
	viennagrid::create_element<TriangularCartesian3D_Cell_t>(segment, vertices.begin(), vertices.end());
	*/
...
TriangularCylindrical3D_Segment::TriangularCylindrical3D_Segment(TriangularCylindrical3D_Segment_t &initial_segment) : segment(initial_segment)
{
	//segment = initial_segment;
}
...
void TriangularCylindrical3D_Segment::create_cell(PointCylindrical3D vertex1, PointCylindrical3D vertex2, PointCylindrical3D vertex3)
{
	...
	vertices[1] = viennagrid::elements<viennagrid::vertex_tag>(domain->get_domain()).handle_at(vertex2.get_id());
	vertices[2] = viennagrid::elements<viennagrid::vertex_tag>(domain->get_domain()).handle_at(vertex3.get_id());
	viennagrid::create_element<TriangularCylindrical3D_Cell_t>(segment, vertices.begin(), vertices.end());
	*/
...
TriangularPolar2D_Segment::TriangularPolar2D_Segment(TriangularPolar2D_Segment_t &initial_segment) : segment(initial_segment)
{
	//segment = initial_segment;
}
...
void TriangularPolar2D_Segment::create_cell(PointPolar2D vertex1, PointPolar2D vertex2, PointPolar2D vertex3)
{
	...
	vertices[1] = viennagrid::elements<viennagrid::vertex_tag>(domain->get_domain()).handle_at(vertex2.get_id());
	vertices[2] = viennagrid::elements<viennagrid::vertex_tag>(domain->get_domain()).handle_at(vertex3.get_id());
	viennagrid::create_element<TriangularPolar2D_Cell_t>(segment, vertices.begin(), vertices.end());
	*/
...
TriangularSpherical3D_Segment::TriangularSpherical3D_Segment(TriangularSpherical3D_Segment_t &initial_segment) : segment(initial_segment)
{
	//segment = initial_segment;
}
...
void TriangularSpherical3D_Segment::create_cell(PointSpherical3D vertex1, PointSpherical3D vertex2, PointSpherical3D vertex3)
{
	...
	vertices[1] = viennagrid::elements<viennagrid::vertex_tag>(domain->get_domain()).handle_at(vertex2.get_id());
	vertices[2] = viennagrid::elements<viennagrid::vertex_tag>(domain->get_domain()).handle_at(vertex3.get_id());
	viennagrid::create_element<TriangularSpherical3D_Cell_t>(segment, vertices.begin(), vertices.end());
	*/
