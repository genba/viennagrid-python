...
s1 = d.segments[1]
s1.create_cell(d.vertices[1], d.vertices[2], d.vertices[4]) # Cell with vertices 1-2-4
s1.create_cell(d.vertices[3], d.vertices[2], d.vertices[4]) # Cell with vertices 3-2-4
